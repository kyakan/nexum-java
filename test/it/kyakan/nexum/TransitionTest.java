...
class TransitionTest {
    ...
    void testSimpleTransition() {
        Transition<TestState, TestEvent> transition = 
            new Transition<>(TestState.IDLE, TestState.RUNNING, TestEvent.START);
    ...
    void testCanTransitionWithGuard() {
        Transition.TransitionGuard<TestState, TestEvent> guard = 
            (ctx, event, data) -> {
        ...
        Transition<TestState, TestEvent> transition = 
            new Transition<>(TestState.IDLE, TestState.RUNNING, TestEvent.START, guard);
    ...
    void testExecuteAction() {
        ...
        Transition.TransitionAction<TestState, TestEvent> action = 
            (ctx, event, data) -> {
        ...
        Transition<TestState, TestEvent> transition = 
            new Transition<>(TestState.IDLE, TestState.RUNNING, TestEvent.START, null, action);
