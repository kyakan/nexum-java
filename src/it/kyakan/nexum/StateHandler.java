...
public interface StateHandler<S, E> {
     ...
     */
    default void onEnter(StateMachineContext<S> context, S fromState, E event) {
     ...
     */
    default void onExit(StateMachineContext<S> context, S toState, E event) {
        // Default implementation does nothing
    }
     ...
     * @param context The state machine context
     */
    default void onUpdate(StateMachineContext<S> context) {
        // Default implementation does nothing
    }
     ...
     */
    default boolean handleEvent(StateMachineContext<S> context, E event, Object eventData) {
