 ...
 * This class provides a flexible state machine that can work with any state and event types.
 * 
...
public class Nexum<S, E> {
     ...
     * This will call exit handlers for the current state and enter handlers for the new state
